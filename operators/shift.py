...
def shift(state: Solution, program_id: str, direction: ShiftDirection, shamt: int) -> Solution:
...
def distance(state: Solution, program_id: str, direction: ShiftDirection) -> int | None:
